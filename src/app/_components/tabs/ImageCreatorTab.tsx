    ...
    <div className="space-y-6">
      <div className="space-y-4">
        ...
        <div className="rounded-lg border border-gray-200 bg-white">
          <textareavalue={prompt}onChange={(e) => onChange(e.target.value)}
        ...
        <div className="flex justify-end">
          <ButtonclassName="bg-zinc-800 hover:bg-zinc-700"onClick={onGenerate}disabled={!prompt.trim() || createLoading}
          >
            {createLoading ? (
